...
#define FIRST_ASSIGNABLE_POS 1163264//PH_USER_START+NUM_PAG_CODE*PAGE_SIZE + NUM_PAG_DATA*PAGE_SIZE //0x100000 + 8 * 4096 + 20 * 4096
#define LAST_POS_MEM 4194304//0x400000 //1024 * 4096
